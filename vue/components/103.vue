<template>
    ...
    <div class="container">
        <div style="padding: 0px; margin: 0px; text-align: center; background-color: #212121; border: 0px solid red;">
            <iframe style="margin: -5px 0 0 -5px; border: 0px solid red; overflow: hidden;" src="https://webinar.tecnoxia.com/hlsplayer/FM103.3.html" width="250" height="45" scrolling="no" align="center" allowfullscreen="allowfullscreen"></iframe>
        </div>  
