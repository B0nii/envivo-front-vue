<template>
  <div >
    <carousel v-if="programacionactualmananera.time_start < moment() && programacionactualmananera.time_end > moment()" :margin="1"  :loop="false" :nav="false" :responsive="{0:{items:2,nav:false},600:{items:3,nav:false}}">
