<template>
    ...
    <div  class="slide-img">
    <a title="LaMañanera" href="https://testdo.radioformula.com.mx/la-mananera-en-vivo/">
        <img :src="programacionactualmananera.programa.image_thumbnail"  class="rounded mx-auto d-block img-fluid">
    </a>
    </div>
    <div class="slide-content" >
    <h3 class="post-title"><a title="LaMañanera" href="https://testdo.radioformula.com.mx/la-mananera-en-vivo/">La Mañanera</a></h3>
    </div>
    </div>
    </div>
