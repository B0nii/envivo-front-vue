<template>
 <carousel  :margin="8"  :merge="true" :loop="true" :nav="false" :responsive="{0:{items:1},600:{items:3}}">
     <!-- Inicia Estacion Coronavirus -->
        <div>
           <a title="Coronavirus minuto a minuto" href="https://testwebrf.radioformula.com.mx/coronavirus-en-tiempo-real/">
          <img  :src="programacionActualCoronavirus.programa.image_thumbnail"  class="rounded mx-auto d-block img-fluid" style="width:330px; height:auto;  margin:auto;">
           ...
           <h4 style="text-align: center;"><a title="LaMañanera" href="https://testwebrf.radioformula.com.mx/coronavirus-en-tiempo-real/"><p style="color:#0f4d97">Conferencia Coronavirus</p></a></h4>
         </div>  
